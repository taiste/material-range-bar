...
public class RangeBar extends View {
    ...
    private static final float DEFAULT_BAR_PADDING_HORIZONTAL_DP = 0;
    ...
    private float mBarPaddingHorizontal = DEFAULT_BAR_PADDING_HORIZONTAL_DP;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        bundle.putFloat("BAR_PADDING_HORIZONTAL", mBarPaddingHorizontal);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (state instanceof Bundle) {
            ...
            mBarPaddingHorizontal = bundle.getFloat("BAR_PADDING_HORIZONTAL");
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        final float marginLeft = Math.max(mExpandedPinRadius, Math.max(mCircleSize, mBarPaddingHorizontal));
    ...
    private void rangeBarInit(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBarPaddingHorizontal = ta.getDimension(R.styleable.RangeBar_rangeBarPaddingHorizontal,
                    TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                            DEFAULT_BAR_PADDING_HORIZONTAL_DP, getResources().getDisplayMetrics()));
    ...
    private float getMarginLeft() {
        return Math.max(mExpandedPinRadius, Math.max(mCircleSize, mBarPaddingHorizontal));
    }
